<!--TITLE: Excel 365 Append Cell Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Excel 365\Cell group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel 365 Append Cell Command


## What does this command do?
This command appends a cell to the first column after the last row in an Excel 365 Worksheet.
...
Automation Class Name: Excel365AppendCellCommand
