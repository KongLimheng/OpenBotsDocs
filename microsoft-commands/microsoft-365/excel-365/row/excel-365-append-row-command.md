<!--TITLE: Excel 365 Append Row Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Excel 365\Row group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel 365 Append Row Command


## What does this command do?
This command appends a row after the last row of an Excel 365 Worksheet.
...
Automation Class Name: Excel365AppendRowCommand
