<!--TITLE: Excel 365 Delete Empty Columns Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Excel 365\Column group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel 365 Delete Empty Columns Command


## What does this command do?
This command deletes all empty Columns from a given range in an Excel 365 Worksheet.
...
Automation Class Name: Excel365DeleteEmptyColumnsCommand
