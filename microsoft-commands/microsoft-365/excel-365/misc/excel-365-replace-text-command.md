<!--TITLE: Excel 365 Replace Text Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Excel 365\Misc group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel 365 Replace Text Command


## What does this command do?
This command finds occurences of a string in the active Worksheet of an Excel 365 Workbook and replaces them with a new string.
...
Automation Class Name: Excel365ReplaceTextCommand
