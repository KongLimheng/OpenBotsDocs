<!--TITLE: Excel 365 Get Table Range Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Excel 365\Table group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel 365 Get Table Range Command


## What does this command do?
This command gets the Range of an Excel 365 Table.
...
|Excel Table Name|Enter the name of the Excel Table to get the Range from.|"TableName" \|\| vTableName||
...
Automation Class Name: Excel365GetTableRangeCommand
