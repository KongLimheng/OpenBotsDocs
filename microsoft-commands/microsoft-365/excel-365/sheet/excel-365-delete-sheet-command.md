<!--TITLE: Excel 365 Delete Sheet Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Excel 365\Sheet group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel 365 Delete Sheet Command


## What does this command do?
This command deletes a specific Worksheet in an Excel 365 Workbook.
...
|Worksheet Name|Specify the Worksheet to delete from the Workbook.|"Sheet1" \|\| vSheet||
...
Automation Class Name: Excel365DeleteSheetCommand
