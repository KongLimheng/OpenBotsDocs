<!--TITLE: Excel 365 Append Sheet Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Excel 365\Sheet group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel 365 Append Sheet Command


## What does this command do?
This command appends a new Worksheet to an Excel 365 Workbook.
...
|Worksheet Name|Specify the Worksheet to append to the Workbook.|"Sheet1" \|\| vSheet||
...
Automation Class Name: Excel365AppendSheetCommand
