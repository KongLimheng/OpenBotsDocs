<!--TITLE: Send Outlook 365 Email Draft Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Outlook 365 group. -->
[Go To Automation Commands Overview](/automation-commands)


# Send Outlook 365 Email Draft Command


## What does this command do?
This command sends a selected draft email in Outlook 365.
...
|Message|Enter the draft Message to send.|vMessage|The 'Microsoft.Graph' assembly reference must be added to 'Imports' to access this type.|
...
Automation Class Name: SendOutlook365EmailDraftCommand
