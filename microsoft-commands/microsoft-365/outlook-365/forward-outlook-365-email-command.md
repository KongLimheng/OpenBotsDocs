<!--TITLE: Forward Outlook 365 Email Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Microsoft 365\Outlook 365 group. -->
[Go To Automation Commands Overview](/automation-commands)


# Forward Outlook 365 Email Command


## What does this command do?
This command forwards a selected email in Outlook 365.
...
|Message|Enter the Message to forward.|vMessage|The 'Microsoft.Graph' assembly reference must be added to 'Imports' to access this type.|
...
Automation Class Name: ForwardOutlook365EmailCommand
