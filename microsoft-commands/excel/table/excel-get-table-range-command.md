<!--TITLE: Excel Get Table Range Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Table group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Get Table Range Command


## What does this command do?
This command gets the Range of an Excel Table.
...
Automation Class Name: ExcelGetTableRangeCommand
