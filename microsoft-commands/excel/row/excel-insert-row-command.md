<!--TITLE: Excel Insert Row Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Row group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Insert Row Command


## What does this command do?
This command inserts a specific blank row in an Excel Worksheet.
...
Automation Class Name: ExcelInsertRowCommand
