<!--TITLE: Excel Append Sheet Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Sheet group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Append Sheet Command


## What does this command do?
This command appends a new Worksheet to an Excel Workbook.
...
|Worksheet Name|Specify the name of the new Worksheet to append.|"Sheet1" \|\| vSheet||
...
Automation Class Name: ExcelAppendSheetCommand
