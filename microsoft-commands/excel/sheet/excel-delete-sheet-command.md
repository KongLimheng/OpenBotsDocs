<!--TITLE: Excel Delete Sheet Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Sheet group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Delete Sheet Command


## What does this command do?
This command deletes a specific Worksheet in an Excel Workbook.
...
|Worksheet Name|Specify the name of the Worksheet to delete.|"Sheet1" \|\| vSheet||
...
Automation Class Name: ExcelDeleteSheetCommand
