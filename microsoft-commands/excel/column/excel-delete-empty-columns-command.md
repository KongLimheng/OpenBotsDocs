<!--TITLE: Excel Delete Empty Columns Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Column group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Delete Empty Columns Command


## What does this command do?
This command deletes all empty Columns from a given range in an Excel Worksheet.
...
Automation Class Name: ExcelDeleteEmptyColumnsCommand
