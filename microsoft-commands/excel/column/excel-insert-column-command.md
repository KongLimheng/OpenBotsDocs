<!--TITLE: Excel Insert Column Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Column group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Insert Column Command


## What does this command do?
This command inserts a specific blank column in an Excel Worksheet.
...
Automation Class Name: ExcelInsertColumnCommand
