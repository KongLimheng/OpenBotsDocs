<!--TITLE: Excel Get Cell Color Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Cell group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Get Cell Color Command


## What does this command do?
This command gets the color from a specific cell in an Excel Worksheet.
...
Automation Class Name: ExcelGetCellColorCommand
