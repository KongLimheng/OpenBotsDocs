<!--TITLE: Excel Activate Range Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Excel\Range group. -->
[Go To Automation Commands Overview](/automation-commands)


# Excel Activate Range Command


## What does this command do?
This command activates a specific range in an Excel Worksheet.
...
|Range|Enter the location of the cell or range to activate.|"A1" \|\| "A1:B10" \|\| "A1:" \|\| vRange \|\| vStart+":+"vEnd \|\| vStart + ":"||
...
Automation Class Name: ExcelActivateRangeCommand
