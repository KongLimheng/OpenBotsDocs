<!--TITLE: PowerPoint Activate Slide Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\PowerPoint\Slide group. -->
[Go To Automation Commands Overview](/automation-commands)


# PowerPoint Activate Slide Command


## What does this command do?
This command activates a PowerPoint Slide (Visible Mode Only).
...
|Slide Location|Indicate the position of the slide to activate.|||
|Slide Index|Enter the index of the slide to activate.|2 \|\| vSlideIndex||
...
Automation Class Name: PowerPointActivateSlideCommand
