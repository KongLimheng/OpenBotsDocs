<!--TITLE: Word Replace Text Command -->
<!-- SUBTITLE: a command in the Microsoft Commands\Word\Content group. -->
[Go To Automation Commands Overview](/automation-commands)


# Word Replace Text Command


## What does this command do?
This command finds occurences of a string in a Word Document and replaces them with a new string.
