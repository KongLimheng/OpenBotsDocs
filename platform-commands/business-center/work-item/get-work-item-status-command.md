<!--TITLE: Get Work Item Status Command -->
<!-- SUBTITLE: a command in the Platform Commands\Business Center\Work Item group. -->
[Go To Automation Commands Overview](/automation-commands)


# Get Work Item Status Command


## What does this command do?
This command gets a Work Item's latest status in OpenBots Server.
...
Automation Class Name: GetWorkItemStatusCommand
