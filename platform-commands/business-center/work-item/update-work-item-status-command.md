<!--TITLE: Update Work Item Status Command -->
...
This command updates a Work Item's status in OpenBots Server.
...
|Work Item Status|Specify the new status of the Work Item.|||
...
Automation Class Name: UpdateWorkItemStatusCommand
