<!--TITLE: Workbook Get Sheet Names Command -->
...
This command retrieves a list of all Worksheet names from a Workbook.
...
Automation Class Name: WorkbookGetSheetNamesCommand
