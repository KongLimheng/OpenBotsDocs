<!--TITLE: Workbook Append Cell Command -->
...
This command appends a cell to the first column after the last row in a Workbook Worksheet.
...
Automation Class Name: WorkbookAppendCellCommand
