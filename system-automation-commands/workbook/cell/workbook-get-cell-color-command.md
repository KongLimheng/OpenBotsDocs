<!--TITLE: Workbook Get Cell Color Command -->
...
This command gets the color from a specific cell in a Workbook Worksheet.
...
Automation Class Name: WorkbookGetCellColorCommand
