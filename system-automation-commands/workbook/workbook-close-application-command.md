<!--TITLE: Workbook Close Application Command -->
...
This command closes an open Workbook and application instance.
...
|Save Workbook|Indicate whether the Workbook should be saved before closing.|||
...
Automation Class Name: WorkbookCloseApplicationCommand
