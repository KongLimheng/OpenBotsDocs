<!--TITLE: Google Workspace Clear Session Cache Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands group. -->
[Go To Automation Commands Overview](/automation-commands)


# Google Workspace Clear Session Cache Command


## What does this command do?
This command clears a Google Workspace session cache.
...
Automation Class Name: GoogleWorkspaceClearSessionCacheCommand
