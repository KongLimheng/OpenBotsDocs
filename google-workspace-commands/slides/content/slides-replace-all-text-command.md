<!--TITLE: Slides Replace All Text Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Slides\Content group. -->
[Go To Automation Commands Overview](/automation-commands)


# Slides Replace All Text Command


## What does this command do?
This command finds occurences of a string in a Google Presentation and replaces them with a new string.
...
Automation Class Name: SlidesReplaceAllTextCommand
