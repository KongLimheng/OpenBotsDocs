<!--TITLE: Slides Create Paragraph Bullets Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Slides\Content group. -->
[Go To Automation Commands Overview](/automation-commands)


# Slides Create Paragraph Bullets Command


## What does this command do?
This command creates paragraph bullets in a given shape.
...
|Shape Id|Enter the Id of the Shape to create paragraph bullets for.|_A1 \|\| vShapeId||
|Bullet Preset|Select the kinds of bullet glyphs to be used.|||
...
Automation Class Name: SlidesCreateParagraphBulletsCommand
