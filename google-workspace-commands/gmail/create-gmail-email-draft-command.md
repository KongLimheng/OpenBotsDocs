<!--TITLE: Create Gmail Email Draft Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Gmail group. -->
[Go To Automation Commands Overview](/automation-commands)


# Create Gmail Email Draft Command


## What does this command do?
This command creates an email draft with optional attachment(s) using the Gmail API.
...
|Output Draft Variable (Optional)|Create a new variable or select a variable from the list.|vUserVariable|New variables/arguments may be instantiated by utilizing the Ctrl+K/Ctrl+J shortcuts.|
...
Automation Class Name: CreateGmailEmailDraftCommand
