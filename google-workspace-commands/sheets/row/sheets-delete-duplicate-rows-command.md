<!--TITLE: Sheets Delete Duplicate Rows Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Sheets\Row group. -->
[Go To Automation Commands Overview](/automation-commands)


# Sheets Delete Duplicate Rows Command


## What does this command do?
This command deletes all duplicate Rows in a Sheets Sheet.
...
Automation Class Name: SheetsDeleteDuplicateRowsCommand
