<!--TITLE: Sheets Delete Empty Columns Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Sheets\Column group. -->
[Go To Automation Commands Overview](/automation-commands)


# Sheets Delete Empty Columns Command


## What does this command do?
"This command deletes all empty Columns from a given range in an Sheets Sheet.
...
Automation Class Name: SheetsDeleteEmptyColumnsCommand
