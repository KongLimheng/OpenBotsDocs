<!--TITLE: Sheets Delete Sheet Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Sheets\Sheet group. -->
[Go To Automation Commands Overview](/automation-commands)


# Sheets Delete Sheet Command


## What does this command do?
This command deletes a specific Sheet in an Sheets Spreadsheet.
...
|Sheet Name|Specify the Sheet to delete from the Spreadsheet.|"Sheet1" \|\| vSheet||
...
Automation Class Name: SheetsDeleteSheetCommand
