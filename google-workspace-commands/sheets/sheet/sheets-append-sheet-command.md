<!--TITLE: Sheets Append Sheet Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Sheets\Sheet group. -->
[Go To Automation Commands Overview](/automation-commands)


# Sheets Append Sheet Command


## What does this command do?
This command appends a new Sheet to an Sheets Spreadsheet.
...
|Sheet Name|Specify the Sheet to append to the Spreadsheet.|"Sheet1" \|\| vSheet||
...
Automation Class Name: SheetsAppendSheetCommand
