<!--TITLE: Sheets Sheet Exists Command -->
<!-- SUBTITLE: a command in the Google Workspace Commands\Sheets\Sheet group. -->
[Go To Automation Commands Overview](/automation-commands)


# Sheets Sheet Exists Command


## What does this command do?
This command checks whether a Sheet exists in an Sheets Spreadsheet.
...
|Sheet Name|Specify the name of the Spreadsheet to check.|"Sheet1" \|\| vSheet||
...
Automation Class Name: SheetsSheetExistsCommand
