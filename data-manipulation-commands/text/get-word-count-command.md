...
This command returns the count of all words in a string.


## Command Parameters
| Parameter Question   	| What to input  	|  Sample Data 	| Remarks  	|
| ---                    | ---               | ---           | ---       |
|Text Data|Provide a variable or text value.|"Hello World" \|\| vStringVariable|Providing data of a type other than a 'String' will result in an error.|
