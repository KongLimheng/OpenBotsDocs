<!--TITLE: Surface Automation Wait For Key On Image Command -->
<!-- SUBTITLE: a command in the Image Automation Commands\Surface Automation group. -->
[Go To Automation Commands Overview](/automation-commands)


# Surface Automation Wait For Key On Image Command


## What does this command do?
This command attempts to find and wait for a key press on an image.
...
Automation Class Name: SurfaceAutomationWaitForKeyOnImageCommand
