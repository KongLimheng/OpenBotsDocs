<!--TITLE: Surface Automation Click Image Command -->
<!-- SUBTITLE: a command in the Image Automation Commands\Surface Automation group. -->
[Go To Automation Commands Overview](/automation-commands)


# Surface Automation Click Image Command


## What does this command do?
This command attempts to find and click an existing image on screen.
...
|Click Position|Specify where the image element should be clicked relative to the captured image.|||
...
Automation Class Name: SurfaceAutomationClickImageCommand
