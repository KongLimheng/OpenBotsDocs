<!--TITLE: Surface Automation Image Exists Command -->
<!-- SUBTITLE: a command in the Image Automation Commands\Surface Automation group. -->
[Go To Automation Commands Overview](/automation-commands)


# Surface Automation Image Exists Command


## What does this command do?
This command attempts to find an existing image on screen and returns the result.
...
Automation Class Name: SurfaceAutomationImageExistsCommand
