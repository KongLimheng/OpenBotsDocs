<!--TITLE: Surface Automation Wait For Click On Image Command -->
<!-- SUBTITLE: a command in the Image Automation Commands\Surface Automation group. -->
[Go To Automation Commands Overview](/automation-commands)


# Surface Automation Wait For Click On Image Command


## What does this command do?
This command attempts to find and wait for a click on an image.
...
Automation Class Name: SurfaceAutomationWaitForClickOnImageCommand
