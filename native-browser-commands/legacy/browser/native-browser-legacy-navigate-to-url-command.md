<!--TITLE: Native Browser Legacy Navigate To URL Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Browser group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Navigate To URL Command


## What does this command do?
This command navigates the browser to the provided URL.
...
|URL|Enter the URL to navigate to.|"https://openbots.ai/" \|\| vURL||
...
Automation Class Name: NativeBrowserLegacyNavigateToURLCommand
