<!--TITLE: Native Browser Legacy Get Text Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Get Text Command


## What does this command do?
This command gets text from a specified element in a browser.
...
Automation Class Name: NativeBrowserLegacyGetTextCommand
