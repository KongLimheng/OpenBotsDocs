<!--TITLE: Native Browser Legacy Set CheckBox Element Toggle State Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Set CheckBox Element Toggle State Command


## What does this command do?
This command sets the toggle state of checkbox/radio button element.
...
|Toggle Type|Select whether to check or uncheck a selected CheckBox.|||
...
Automation Class Name: NativeBrowserLegacySetCheckBoxElementToggleStateCommand
