<!--TITLE: Native Browser Legacy Capture Element Region Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Capture Element Region Command


## What does this command do?
This command captures a web element region in a browser.
...
Automation Class Name: NativeBrowserLegacyCaptureElementRegionCommand
