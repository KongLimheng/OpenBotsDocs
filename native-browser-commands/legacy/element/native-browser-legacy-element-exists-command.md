<!--TITLE: Native Browser Legacy Element Exists Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Element Exists Command


## What does this command do?
This command checks if a specified element exists in a browser.
...
Automation Class Name: NativeBrowserLegacyElementExistsCommand
