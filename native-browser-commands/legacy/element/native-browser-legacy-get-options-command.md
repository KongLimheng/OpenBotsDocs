<!--TITLE: Native Browser Legacy Get Options Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Get Options Command


## What does this command do?
This command gets a list of options from a specified dropdown in a browser.
...
|Attribute Name|Specify the name of the attribute to retrieve from the dropdown options.|||
...
Automation Class Name: NativeBrowserLegacyGetOptionsCommand
