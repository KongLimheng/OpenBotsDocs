<!--TITLE: Native Browser Legacy Wait For Element To Exist Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Wait For Element To Exist Command


## What does this command do?
This command waits for a specified element to exist in a browser.
...
Automation Class Name: NativeBrowserLegacyWaitForElementToExistCommand
