<!--TITLE: Native Browser Legacy Clear Text Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Clear Text Command


## What does this command do?
This command clears text from a specified input in a browser.
...
Automation Class Name: NativeBrowserLegacyClearTextCommand
