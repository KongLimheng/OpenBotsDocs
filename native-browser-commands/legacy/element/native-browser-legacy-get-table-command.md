<!--TITLE: Native Browser Legacy Get Table Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Get Table Command


## What does this command do?
This command gets a table from a specified element in a browser.
...
Automation Class Name: NativeBrowserLegacyGetTableCommand
