<!--TITLE: Native Browser Legacy Set Option Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Element group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Set Option Command


## What does this command do?
This command sets the option of a specified dropdown in a browser.
...
|Selection Rule|Select the method by which the dropdown option should be selected.|||
|Selection Index|Enter the value that will be used to select the option in the dropdown.|0 \|\| vIndex||
|Selection Text|Enter the value that will be used to select the option in the dropdown.|"Hello World" \|\| vText||
...
Automation Class Name: NativeBrowserLegacySetOptionCommand
