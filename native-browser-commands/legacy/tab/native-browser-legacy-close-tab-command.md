<!--TITLE: Native Browser Legacy Close Tab Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Tab group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Close Tab Command


## What does this command do?
This command closes the currently active browser tab.
...
Automation Class Name: NativeBrowserLegacyCloseTabCommand
