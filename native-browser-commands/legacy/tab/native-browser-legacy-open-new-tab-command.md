<!--TITLE: Native Browser Legacy Open New Tab Command -->
<!-- SUBTITLE: a command in the Native Browser Commands\Legacy\Tab group. -->
[Go To Automation Commands Overview](/automation-commands)


# Native Browser Legacy Open New Tab Command


## What does this command do?
This command opens a new tab and navigates to the provided URL.
...
Automation Class Name: NativeBrowserLegacyOpenNewTabCommand
