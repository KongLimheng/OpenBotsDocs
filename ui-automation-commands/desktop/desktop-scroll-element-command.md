<!--TITLE: Desktop Scroll Element Command -->
...
This command performs a scroll on a scrollable panel UI element (Windows) or scrolls to a targeted UI element (Browser) in a targeted window.


## Command Parameters
| Parameter Question   	| What to input  	|  Sample Data 	| Remarks  	|
| ---                    | ---               | ---           | ---       |
|Scroll Direction|Select whether to scroll vertically or horizontally.|||
|Scroll Percentage|Specify the percentage of the total vertical/horizontal content area to scroll to.|0 \|\| 100 \|\| vPercentage|The element selected should not be the scrollbar itself.|
...
Automation Class Name: DesktopScrollElementCommand
