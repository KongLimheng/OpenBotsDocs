<!--TITLE: Desktop Wait For Click On Element Command -->
...
This command pauses execution until the indicated click on the targeted UI element is detected.
...
Automation Class Name: DesktopWaitForClickOnElementCommand
