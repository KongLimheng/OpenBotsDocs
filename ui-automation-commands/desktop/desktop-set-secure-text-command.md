<!--TITLE: Desktop Set Secure Text Command -->
...
This command sets secure text in a UI element in a targeted window.
...
Automation Class Name: DesktopSetSecureTextCommand
