<!--TITLE: Desktop Get CheckBox Element Toggle State Command -->
<!-- SUBTITLE: a command in the UI Automation Commands\Desktop group. -->
[Go To Automation Commands Overview](/automation-commands)


# Desktop Get CheckBox Element Toggle State Command


## What does this command do?
This command gets the toggle state of a UI element in a targeted window.
...
Automation Class Name: DesktopGetCheckBoxElementToggleStateCommand
