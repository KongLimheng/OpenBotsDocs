<!--TITLE: Desktop Click Element Command -->
...
This command clicks a UI element in a targeted window.


## Command Parameters
| Parameter Question   	| What to input  	|  Sample Data 	| Remarks  	|
| ---                    | ---               | ---           | ---       |
|Click Type|Specify how the element should be clicked.|||
|Click Button|Please specify the mouse button used for the click action.|||
|Click Type|Please specify how an element should be clicked.||If selected, *Simulate Click* will simulate a background click using javascript. Otherwise it will be a regular mouse click. Also *Mouse Click* is not supported for elements within IFrames|
...
Automation Class Name: DesktopClickElementCommand
