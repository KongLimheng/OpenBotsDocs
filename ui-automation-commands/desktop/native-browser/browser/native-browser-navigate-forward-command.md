<!--TITLE: Native Browser Navigate Forward Command -->
...
This command navigates forward through the browser history list.
...
Automation Class Name: NativeBrowserNavigateForwardCommand
