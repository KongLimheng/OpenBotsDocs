<!--TITLE: Desktop Hover Over Element Command -->
...
This command hovers over a UI element in a targeted window.
...
|Hover Time (Seconds)|Specify how many seconds to hover over the windows element.|30 \|\| vSeconds||
...
Automation Class Name: DesktopHoverOverElementCommand
