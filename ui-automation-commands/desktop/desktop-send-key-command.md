<!--TITLE: Desktop Send Key Command -->
...
This command sends a key(s) to a UI element in a targeted window.
...
|Click Element|Select whether the element should be clicked before sending a key(s).|||
...
Automation Class Name: DesktopSendKeyCommand
