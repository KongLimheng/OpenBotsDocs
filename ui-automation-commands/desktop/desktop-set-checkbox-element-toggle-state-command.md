<!--TITLE: Desktop Set CheckBox Element Toggle State Command -->
<!-- SUBTITLE: a command in the UI Automation Commands\Desktop group. -->
[Go To Automation Commands Overview](/automation-commands)


# Desktop Set CheckBox Element Toggle State Command


## What does this command do?
This command sets the toggle state of a checkbox UI element in a targeted window.
...
Automation Class Name: DesktopSetCheckBoxElementToggleStateCommand
