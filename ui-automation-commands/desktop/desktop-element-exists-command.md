<!--TITLE: Desktop Element Exists Command -->
...
This command determines whether a UI element exists in a targeted window.
...
Automation Class Name: DesktopElementExistsCommand
