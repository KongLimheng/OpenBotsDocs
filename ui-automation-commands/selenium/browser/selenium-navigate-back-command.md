<!--TITLE: Selenium Navigate Back Command -->
...
This command navigates backwards in a Selenium web browser session.
...
Automation Class Name: SeleniumNavigateBackCommand
