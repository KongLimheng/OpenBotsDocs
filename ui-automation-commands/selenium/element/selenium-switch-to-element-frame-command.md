<!--TITLE: Selenium Switch To Element Frame Command -->
...
This command switches to a frame containing an element in a Selenium web browser session.
...
Automation Class Name: SeleniumSwitchToElementFrameCommand
