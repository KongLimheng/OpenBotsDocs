<!--TITLE: Selenium Get Dropdown Options Command -->
...
This command gets dropdown options from an element in a Selenium web browser session.
...
Automation Class Name: SeleniumGetDropdownOptionsCommand
