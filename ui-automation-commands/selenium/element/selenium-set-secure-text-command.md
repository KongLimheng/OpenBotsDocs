<!--TITLE: Selenium Set Secure Text Command -->
...
This command sets secure text in an element in a Selenium web browser session.
...
|SecureString To Set|Enter the SecureString variable to set in the input.|vSecureText||
...
Automation Class Name: SeleniumSetSecureTextCommand
