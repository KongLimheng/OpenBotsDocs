<!--TITLE: Selenium Capture Element Region Command -->
...
This command captures the region of an element in a Selenium web browser session.
...
Automation Class Name: SeleniumCaptureElementRegionCommand
