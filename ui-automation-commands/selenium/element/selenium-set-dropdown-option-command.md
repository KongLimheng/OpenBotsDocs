<!--TITLE: Selenium Set Dropdown Option Command -->
...
This command sets the dropdown option of an element in a Selenium web browser session.
...
|Selection Type|Determine the attribute by which a dropdown option will be selected.|||
...
Automation Class Name: SeleniumSetDropdownOptionCommand
