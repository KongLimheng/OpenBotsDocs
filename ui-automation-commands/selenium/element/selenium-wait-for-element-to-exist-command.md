<!--TITLE: Selenium Wait For Element To Exist Command -->
...
This command waits for an element to exist in a Selenium web browser session.
...
Automation Class Name: SeleniumWaitForElementToExistCommand
