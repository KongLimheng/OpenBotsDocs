<!--TITLE: Selenium Element Exists Command -->
...
This command determines whether an element exists in a Selenium web browser session.
...
Automation Class Name: SeleniumElementExistsCommand
