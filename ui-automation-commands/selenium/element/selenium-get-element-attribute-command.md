<!--TITLE: Selenium Get Element Attribute Command -->
...
This command gets an attribute from an element in a Selenium web browser session.
...
|Attribute Name|Specify the name of the attribute to retrieve from the dropdown options.|"value" \|\| "class" \|\| "name" \|\| "id" \|\| vAttributeName||
...
Automation Class Name: SeleniumGetElementAttributeCommand
